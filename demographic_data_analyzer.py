...
def calculate_demographic_data(print_data=True):
    ...
    # Percentage with salary >50K for higher and lower education
    ...
    highest_earning_country_percentage = round((country_earnings / country_population * 100).max(), 1)
    highest_earning_country = (country_earnings / country_population * 100).idxmax()
